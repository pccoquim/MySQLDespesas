ALTER TABLE tbl_0302_movimentosdebito_det ADD md_datecreate VARCHAR(8) DEFAULT '0' AFTER md_userreg, ADD md_datelastchg VARCHAR(8) DEFAULT '0', ADD md_timelastchg VARCHAR(6) DEFAULT '0';

ALTER TABLE tbl_0302_movimentosdebito_det ADD md_timecreate VARCHAR(6) DEFAULT '0' NOT NULL AFTER md_datecreate;

ALTER TABLE tbl_0302_movimentosdebito_det ADD md_datamov VARCHAR(8) DEFAULT '0' NOT NULL AFTER md_codiva;

UPDATE tbl_0302_movimentosdebito_det
...
ALTER TABLE tbl_0302_movimentosdebito_det
