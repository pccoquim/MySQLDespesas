...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'desp')
BEGIN
...
GRANT CONTROL ON DATABASE::desp TO UserGestao12345678;
...
CREATE TABLE tbl_0001_status(
	...
	stt_usercreate VARCHAR(30) NOT NULL,
	stt_datecreate VARCHAR(8) NOT NULL,
	stt_timecreate VARCHAR(6) NOT NULL,
...
CREATE TABLE tbl_0002_users(
    ...
    usr_usercreate VARCHAR(30) NOT NULL,
    usr_datecreate VARCHAR(8) NOT NULL,
	usr_timecreate VARCHAR(6) NOT NULL,
...
CREATE TABLE tbl_0003_opcoesAcesso(
	...
	opm_usercreate VARCHAR(30)NOT NULL,
...
CREATE TABLE tbl_0004_acessos(
	...
	acs_userlstchg VARCHAR(100) NOT NULL,
...
CREATE TABLE tbl_0101_tipoterceiro(
	...
	ttc_usercreate VARCHAR(100)NOT NULL,
	ttc_datecreate VARCHAR(8) NOT NULL,
	ttc_timecreate VARCHAR(6) NOT NULL,
	ttc_userlstchg VARCHAR(100) NOT NULL,
...
CREATE TABLE tbl_0102_terceiros(
	...
	trc_usercreate VARCHAR(100)NOT NULL,
	trc_datecreate VARCHAR(8) NOT NULL,
	trc_timecreate VARCHAR(6) NOT NULL,
	trc_userlstchg VARCHAR(100) NOT NULL,
...
INSERT INTO tbl_0001_status (stt_cod, stt_descr, stt_usrcreate, stt_datecreate, stt_timecreate, stt_userlstchg, stt_datelstchg, stt_timelstchg)
VALUES  ("1", "Ativo", "Master", "19000101", "000001", "0", "0", "0"),
		("2", "Inativo", "Master", "19000101", "000001", "0", "0", "0");

INSERT INTO tbl_0002_users (usr_userID, usr_name, usr_password, usr_type, usr_status, usr_chgpw, usr_pwcount, usr_usercreate, usr_datecreate, usr_timecreate, usr_userlstchg, usr_datelstchg, usr_timelstchg)
VALUES ("Admin", "Administrador", "!@#$%^&*", "Administrador", "1", "0", "0", "Master", "19000101", "000001", "0", "0", "0");

INSERT INTO tbl_0003_opcoesacesso (opm_cod, opm_descr, opm_nivel, opm_status, opm_usercreate, opm_datecreate, opm_timecreate, opm_userlstchg, opm_datelstchg, opm_timelstchg)
